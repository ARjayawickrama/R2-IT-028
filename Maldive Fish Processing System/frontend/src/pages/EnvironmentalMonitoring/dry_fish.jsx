...
export default function DryFishMonitor() {
    ...
    client.on('message', (topic, message) => {
      if (topic === 'aquasense/fish/telemetry') {
        try {
          ...
          // Update environmental readings & hardware states
  ...
  // Thermal Palette for Light Theme
  const getThermalStyle = (t) => {
    if (t >= 50) return { bg: '#ef4444', text: '#ffffff' }; 
    if (t >= 42) return { bg: '#f97316', text: '#ffffff' }; 
    if (t >= 35) return { bg: '#f59e0b', text: '#ffffff' }; 
    if (t >= 30) return { bg: '#eab308', text: '#1e293b' }; 
    if (t >= 26) return { bg: '#06b6d4', text: '#ffffff' }; 
    if (t >= 22) return { bg: '#3b82f6', text: '#ffffff' }; 
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans p-4 md:p-8 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-2 bg-white border border-slate-200 rounded-3xl p-6 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
          ...
          <div className="flex items-start justify-between flex-wrap gap-4 mb-4">
            <div>
              ...
              <p className="text-[11px] text-slate-500 mt-1">8×8 Infrared Focal Plane Array · Real-time Hotspot Tracking</p>
            </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6 my-2">
                ...
                {thermalMatrix.map((pixelTemp, idx) => {
                  ...
                  return (
                    <div
                      ...
                      className="w-6 h-6 sm:w-7 sm:h-7 rounded-lg transition-all duration-300 flex items-center justify-center text-[8px] font-black cursor-pointer hover:scale-110"
                      style={{ 
            ...
            <div className="flex flex-col justify-center space-y-3 w-full sm:w-auto">
              ...
              <div className="w-full sm:w-48 h-3 rounded-full bg-gradient-to-r from-blue-500 via-amber-400 to-red-500 shadow-inner" />
              ...
              <div className="text-[10px] text-slate-400 leading-tight max-w-xs">
