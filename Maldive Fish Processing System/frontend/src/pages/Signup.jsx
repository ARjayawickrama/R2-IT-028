        ...
        <div className="flex-1 flex items-center justify-center p-8">
          <div className="w-full max-w-md bg-white rounded-xl shadow-2xl border border-gray-200">
            ...
            <div className="bg-gradient-to-r from-blue-600 to-cyan-600 text-white p-6 rounded-t-xl">
              ...
              <p className="text-center text-blue-100 text-sm mt-1">Join our fish processing management system</p>
            </div>
            ...
            <div className="p-6">
              ...
              <form onSubmit={handleSubmit}>
                <div className="mb-5">
                  ...
                  {errors.name && <p className="text-red-500 text-sm mt-1 flex items-center"><svg className="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clipRule="evenodd" /></svg>{errors.name}</p>}
                </div>
              ...
              <p className="text-center text-gray-700 text-sm mt-6">
                Already have an account? <Link to="/login" className="text-blue-600 hover:text-blue-700 font-semibold transition-colors">Sign in instead</Link>
              </p>
            </div>
          </div>
        </div>
