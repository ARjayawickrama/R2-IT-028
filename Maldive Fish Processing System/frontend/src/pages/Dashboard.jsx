        ...
        <div className="space-y-6">
          <div className="bg-white rounded-xl shadow-md border border-gray-200 p-6">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div>
                <h2 className="text-xl font-bold text-gray-900">Production Monitoring</h2>
                <p className="text-sm text-gray-600 mt-1">Real-time chamber status and production metrics</p>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {chamberData.map((chamber) => (
              <div key={chamber.id} className="bg-white rounded-xl shadow-md p-6 border border-gray-200">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-lg font-semibold text-gray-900">{chamber.name}</h3>
                  <div className={`w-3 h-3 rounded-full ${getStatusColor(chamber.status)} ${chamber.status === 'active' ? 'animate-pulse' : ''}`}></div>
                </div>
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-medium">{chamber.efficiency}%</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-600">Operator:</span>
                    <span className="font-medium">{chamber.operator}</span>
                  </div>
                </div>
              </div>
            ))}
